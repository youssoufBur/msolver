...
python3 manage.py makemigrations parameter xauth statistic pharmacie health caisse calendarapp medicalsecretariat hospitalisation imagerie laboratoire actually
